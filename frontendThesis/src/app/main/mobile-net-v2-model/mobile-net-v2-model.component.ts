...
@Component({
  selector: 'app-mobile-net-v2-model',
  templateUrl: './mobile-net-v2-model.component.html',
  styleUrl: './mobile-net-v2-model.component.scss'
})
export class MobileNetV2ModelComponent implements OnInit, AfterViewInit {
  ...
  onUpload(file: File) {
    ...
    this.isLoading = true;
    this.predictionService.ApiMobileNetV2PredictionPost(file).subscribe(
      response => {
        this.model = response;
  ...
  fetchAccuracyPerCategoryData() {
    this.accuracyService.ApiMobileNetV2AccuracyPerCategoryGet().subscribe(
  ...
  fetchAccuracyPerArticleTypeData() {
    this.accuracyService.ApiMobileNetV2AccuracyPerArticleTypeGet().subscribe(
