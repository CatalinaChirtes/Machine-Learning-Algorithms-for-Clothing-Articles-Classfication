...
@Component({
  selector: 'app-inception-res-net-v2-model',
  templateUrl: './inception-res-net-v2-model.component.html',
  styleUrl: './inception-res-net-v2-model.component.scss'
})
export class InceptionResNetV2ModelComponent implements OnInit, AfterViewInit {
  ...
  onUpload(file: File) {
    ...
    this.isLoading = true;
    this.predictionService.ApiInceptionResNetV2PredictionPost(file).subscribe(
      response => {
        this.model = response;
  ...
  fetchAccuracyPerCategoryData() {
    this.accuracyService.ApiInceptionResNetV2AccuracyPerCategoryGet().subscribe(
  ...
  fetchAccuracyPerArticleTypeData() {
    this.accuracyService.ApiInceptionResNetV2AccuracyPerArticleTypeGet().subscribe(
