...
# Training the CNN with data augmentation
model.fit(datagen.flow(x_train, y_train, batch_size=64), steps_per_epoch=len(x_train) / 64, epochs=100)
...
svm_classifier = svm.SVC(kernel='rbf', C=10, gamma=0.01)
...
model.save('improved_CNN_SVM_100.keras')
print("Saving the model as improved_CNN_SVM_100.keras")
